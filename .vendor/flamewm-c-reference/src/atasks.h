...
public:
    ...
    TaskButton* buttonAt(int index) const;
    int indexOfButton(TaskButton* button) const;
    void insertButtonAt(TaskButton* button, int index);
    void moveButtonTo(TaskButton* button, int index);

    // Hosts may override this for vertical task panels.
    virtual bool taskButtonsHorizontal() const { return true; }
...
private:
    ...
    int fDragX;
    int fDragY;
    bool fDragThresholdMet;
    int fDragOriginIndex = -1;
