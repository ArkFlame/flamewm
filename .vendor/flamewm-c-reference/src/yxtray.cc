...
public:
    ...
    virtual ~YXTrayProxy();
    static bool ownerExists() { return singleton != nullptr; }
    ...
    fDrawBevel(drawBevel)
{
    ...
    // XEmbed selection is global. Additional output views must not claim it.
    fTrayProxy = YXTrayProxy::ownerExists() ? nullptr : new YXTrayProxy(atom, this);
    regainTrayWindows();
}
