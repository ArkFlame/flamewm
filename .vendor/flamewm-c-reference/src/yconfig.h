...
public:
    ...
    // FW-CONFIG-01: when Runtime effective authority exists, prefer it over
    // direct file reads. Returns true if effective snapshot was consumed.
    static bool consumeRuntimeEffective();
